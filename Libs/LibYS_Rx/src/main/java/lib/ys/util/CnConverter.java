...
public class CnConverter {
    private static int[] mPYVal = null;
    private static String[] mPYStr = null;

    private static void initPYVal() {
        if (mPYVal != null) {
            return;
        }

        mPYVal = new int[]{-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
    ...
    private static void initPYStr() {
        if (mPYStr != null) {
            return;
        }

        mPYStr = new String[]{"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
    ...
    public static String convert(String str) {
        ...
        if (ascii > 0 && ascii < 160) {
            ...
            initPYStr();
            initPYVal();
            for (int i = (mPYVal.length - 1); i >= 0; i--) {
                if (mPYVal[i] <= ascii) {
                    result = mPYStr[i];
                    break;
                }
